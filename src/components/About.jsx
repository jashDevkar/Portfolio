    ...
    <section className="border-b-2 border-gray-500 pb-6" ref={aboutRef}>
      ...
      <div className="md:px-10 px-8">
        <p className="text-justify bg-[#2C2C2C]/80 p-6 rounded-lg">
          ...
          as 'Notesspehere,' a React Native app that helps computer engineering
          students with notes. I have experience working with the MERN stack and
          have recently been exploring Flutter, tackling challenges like version
          compatibility issues along the way. I balance college, gym, and
          commuting while constantly improving my development skills and
