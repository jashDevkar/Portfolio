  ...
  return (
    <section className=" flex justify-center items-center h-[90vh] flex-col text-center border-b-gray-500 border-b-2 mt-[20px]">
          ...
          <div className="md:w-[40%] flex justify-evenly mt-[20px] gap-3 md:gap-0  ">
            ...
            <button className="flex justify-center items-center gap-1 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-e-full rounded-s-full pt-2 pb-2 pl-3 pr-3 text-[12px] md:text-[16px]">About me <FaArrowRight/></button>
          </div>
