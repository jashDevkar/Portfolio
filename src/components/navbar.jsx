  ...
  return (
    <nav className={`flex md:justify-around justify-between px-11 w-full  border-b-gray-500 border-b-2 py-3  items-center shadow-md bg-[#161512]/50  backdrop-blur-sm relative `}>
      <h1 className="font-Pacifico text-[32px]  bg-gradient-to-r  from-purple-500 via-pink-500 to-orange-500 text-transparent bg-clip-text cursor-pointer"><a>Jash</a></h1>
      {
        ...
        <ul className={` hidden md:static md:flex flex-row h-fit justify-evenly md:w-[40%] md:bg-transparent text-white font-semibold tracking-wide overflow-hidden`}>
        ...
        <ul className={`top-2 pl-4 pb-4 pr-2 pt-2 w-[50%] md:hidden ${open?'right-2 absolute ':'right-[-2clsl00px] absolute '} rounded bg-gradient-to-br from-[#0e0c0b] via-[#221f1d] to-[#2d2a28] backdrop-blur-xl transition-all ease-in-out duration-1000`}>
