...
function Description({ name, fun }) {
    ...
    const des = [
        ...
        {
            name: 'Todo', text: `A todo app with functionality of add ,delete, edit a task. A task can contain title ,description and priority
            toggle {high/low} and due date where user can select due date for each task. Also this app has a filter option. All data is stored locally.`}
    ]
    ...
    return (
        <div className="relative group md:w-[50%] mx-4 bg-gradient-to-br from-purple-950 to-slate-900 backdrop-blur-sm mt-[30px] py-5">
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 w-0 h-0 border-l-[10px] border-r-[10px] border-b-[10px] border-transparent border-b-purple-950" />
